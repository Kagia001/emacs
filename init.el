...
(add-to-list 'default-frame-alist '(font . "fira code nerd font 13")) ; Font needs to have this list format to work as daemon
...
(use-package smart-mode-line            ; Good looking modeline
  :config
  (setq sml/theme 'atom-one-dark)
  (sml/setup))

(use-package smart-tabs-mode            ; Better tab for indent
  :config
  (smart-tabs-mode 1))
